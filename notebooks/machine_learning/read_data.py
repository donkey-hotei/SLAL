...
def read_vectors(filename):
    ...
    Procedure returns a list of Vectors, one for each line of numeric data.
    The labels for the Vectors are the strings given in the first line.
    """
    with open(filename) as file:
        labels = file.readline().split() # splits the first line 
